...
public class ExercicioList1 {
    public static void main(String[] args) {
        ...
        double temperaturaMediaSemestre = soma / temperaturas.size();


        System.out.println("Temperatura Semestral: " + temperaturas);
        System.out.printf("Média de Temperatura Semestral: %.1f", temperaturaMediaSemestre, " °C");

        for (double temp : temperaturas) {
            if (temp > temperaturaMediaSemestre) {
